 ...
 * Maps priority keys → semantic colors from theme.md §2.7
 *
...
const PRIORITY_CONFIG = {
  low:      { fg: '#4B5A6A', bg: '#EEF1F4', border: '#D2D9E0', icon: <ArrowDown size={11} /> },
  medium:   { fg: '#2563a8', bg: '#dceaf7', border: '#a8c0d6', icon: <Minus size={11} /> },
  high:     { fg: '#B5540A', bg: '#FCE9D9', border: '#F0BE8E', icon: <ArrowUp size={11} /> },
  critical: { fg: '#B3241F', bg: '#FBE2E1', border: '#F0AFAC', icon: <AlertTriangle size={11} /> },
}
